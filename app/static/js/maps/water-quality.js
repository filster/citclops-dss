...
function deployDateControl(map) 
{
    ...
    $('#datetimepicker1').data("DateTimePicker").setDate(today);
    $('#datetimepicker1').on('dp.change', function(e) {
        refreshSuitability($('#datetimepicker1').data("DateTimePicker").getDate());
        refreshSatelliteData($('#datetimepicker1').data("DateTimePicker").getDate());
    });
}
